    ...
    describe('Datastore Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/datastores';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Datastore', () => {
                service.create(new Datastore(null)).subscribe(received => {
            ...
            it('should update a Datastore', () => {
                service.update(new Datastore(123)).subscribe(received => {
            ...
            it('should return a list of Datastore', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Datastore(123)]);
            });
